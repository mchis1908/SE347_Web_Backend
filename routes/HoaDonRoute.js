...
router.get('/gethoadonbykhachhang/:sdtKhachHang', HoaDonController.GetHoaDonKyByKhachHang)
router.get('/gethoadonbykhachhang/:sdtKhachHang/:maHD', HoaDonController.GetHoaDonKyByMAHDKhachHang)
